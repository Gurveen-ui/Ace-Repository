...
<tileset version="1.10" tiledversion="1.12.2" name="Walls" tilewidth="80" tileheight="80" tilecount="15" columns="3">
 <image source="../Tileset Images/Walls.png" width="240" height="400"/>
 <wangsets>
  <wangset name="Walls" type="corner" tile="-1">
   ...
   <wangtile tileid="6" wangid="0,2,0,1,0,1,0,1"/>
   <wangtile tileid="7" wangid="0,2,0,1,0,1,0,2"/>
   <wangtile tileid="8" wangid="0,1,0,1,0,1,0,2"/>
